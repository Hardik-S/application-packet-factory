...
- The source files named in the fixture, such as `synthetic-role-brief.md` and `synthetic-master-facts.json`, are provenance labels, not real documents in this public demo.
...
- Add a real copy/download control for the Markdown packet.
